...
- 44 of the 60 real Standard generals (15 per kingdom — verified directly against the upstream C++ source, not the previously-stale "46" count) and their skills (the other 16 need subsystems — judge-area/delayed tricks, armor, pindian, a "give away any number of cards" card-effect type, etc. — not built yet; see `webport/README.md` for the exact list and reasoning per general).
